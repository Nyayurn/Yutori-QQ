...
@Data
@NoArgsConstructor
public class PrivateMessageDeletedEvent extends MessageDeletedEvent {
    public PrivateMessageDeletedEvent(Integer id, Long timestamp, User user, Message message, Channel channel,
