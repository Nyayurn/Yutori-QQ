...
package com.yurn.satori.framework.qq.event.message.deleted;
...
@Data
@NoArgsConstructor
public class MessageDeletedEvent extends UserEvent {
    /**
     * 消息信息
     */
    ...
    public MessageDeletedEvent(Integer id, Long timestamp, User user, Message message, Channel channel, List<BaseMessageElement> chain) {
